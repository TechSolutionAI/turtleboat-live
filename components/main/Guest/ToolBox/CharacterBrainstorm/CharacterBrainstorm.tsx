...
const CharacterBrainstorm = () => {
  ...
  useEffect(() => {
    document.title = "Guest ToolBox - Character Brainstorm - Turtle Boat";
    setIsEditable(true);
  }, []);
            ...
            >
              <div className="absolute z-50 mt-5 left-[30px] border-2 border-secondary-gray w-[350px] rounded-lg bg-white">
                ...
                <div className="text-[14px] px-[15px] py-[15px]">
                  Most users don’t live in isolated silos….they live/work/play
                  and interact with other people. Whether it’s monetary,
                  societal, political, psychological, or other reasons, there
                  are other influencers that can stand in the way of your
                  success. Some may influence more than others, but it’s
                  important to understand how it links and what could help or
                  hinder your success. Use this tool to play out different
                  scenarios of Who Should Care & Why, and how that can affect
                  who buys and/or pays for the product if the user has less
                  ability to do so. And if a potential Character can stop you
                  from succeeding, what are things they care about that can
                  transform them into an ally instead?
                </div>
              </div>
            </OutsideClickHandler>
          )}
          ...
          {!isAddingCharacter ? (
            <div className="rounded-lg bg-tertiary-blue text-primary-blue p-3 m-3">
              ...
              <div className="font-Inter text-sm">
                Select a character card from the brainstorm map to edit their
                problem traits.
              </div>
            </div>
          ) : (
