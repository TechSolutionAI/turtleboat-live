...
const SolutionComicGenerator = ({
    ...
    const [title, setTitle] = useState<string>('Solution Comic Strip');
    const [tempTitle, setTempTitle] = useState<string>('Solution Comic Strip');
        ...
        <>
                        ...
                        <div className="relative bg-white rounded-lg shadow">
                            ...
                            <div className="px-6 py-4 border-b rounded-t ">
                                <h3 className="text-base font-semibold text-gray-900 lg:text-xl">
                                    Tips for The Solution Comic Strip
                                </h3>
                            </div>
                            <div className="p-6">
                                <div>
            ...
            <div className='pt-[60px] overflow-x-hidden overflow-y-auto md:-mx-12 sm:-mx-6 -mx-4 comicstrip-panel grid grid-cols-1 lg:grid-cols-12'>
                ...
                <div className="lg:col-span-10 col-span-1 p-8 overflow-y-scroll h-inherit">
                    ...
                    <div>
                        <h2 className='text-red-500 text-[24px] font-semibold'>
                            imagine &quot;a day in the life of&quot; storyboard with your solution
                        </h2>
                    </div>
...
export default SolutionComicGenerator;