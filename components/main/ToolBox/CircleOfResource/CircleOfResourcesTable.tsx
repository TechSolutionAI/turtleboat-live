          ...
          <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div className="flex min-w-full justify-end items-center mb-5">
              ...
              {isEditable && (
                ...
                >
                  <AddCircleIcon
                    className="m-auto font-Inter mr-1"
                    fontSize="medium"
                  />
                  <span>Add Row</span>
                </div>
                        ...
                        {row.cells.map((cell: any, cellId: number) => {
                          return (
                            <td
                              ...
                              style={{
                                width:
                                  cell.column.id === "descriptionOfAsset" ||
                            ...
                            >
                              {cell.column.id == "circleDistance" ? (
                                <button
                                  style={{
                                    backgroundColor:
                                      circleOfResources[cell.value].color,
                                  }}
                                  className="text-white px-3 py-1 rounded-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 cursor-default"
                                >
                                  {circleOfResources[cell.value].name}
                                </button>
