...
const Upload = ({
    ...
    const [isStart, setIsStart] = useState(isInit);
    ...
    return (
        <div className='sm:mt-[35px] mt-[10px]'>
            ...
            {
                <div className='bg-white sm:h-[130px] h-[90px] mt-[10px] border-dashed border-2 border-secondary-gray flex flex-col items-center justify-evenly'>
