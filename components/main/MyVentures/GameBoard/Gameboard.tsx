            ...
            <div className="flex flex-row justify-center mt-[30px]">
              {memberType == "mentor" &&
                <>
                  ...
                  <EvaluatorAssessmentModal closeModal={closeEvaluatorAssessmentModal} showModal={showEvaluatorAssessmentModal} vid={ventureId} user={user} assessment={assessment} handleAssessment={setAssessment} articulate={articulate} handleArticulate={setArticulate} />
                </>
              }
