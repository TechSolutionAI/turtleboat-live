...
interface EvaluatorAssessmentModalProps {
    ...
    user: User;
    assessment: number[];
    handleAssessment: React.Dispatch<React.SetStateAction<number[]>>;
    articulate: number[];
    handleArticulate: React.Dispatch<React.SetStateAction<number[]>>;
}

const EvaluatorAssessmentModal = ({ showModal, closeModal, vid, user, assessment, handleAssessment, articulate, handleArticulate }: EvaluatorAssessmentModalProps) => {
    ...
    const updateAssessment = async () => {
        ...
        if (chosenAll) {
            ...
            if (!response.ok) {
                ...
                setAssessing(false);
                handleAssessment(result.value);
                handleArticulate(result.articulate);
                Swal.fire({
                    icon: "success",
                    title: "Success!",
